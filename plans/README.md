...
| [`v3/`](v3/) | Extend the CLI beyond the platform account — read connected-account data via the `Stripe-Account` header, and add the Connect-only resources. | phase 1 done |
