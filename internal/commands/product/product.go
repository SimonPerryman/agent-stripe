...
func runList(ctx context.Context, opts *cli.GlobalOpts, args []string) error {
	...
	if opts.Stream {
		...
		return cli.StreamList(ctx, opts, opts.Client.V1Products.List(ctx, params), cap)
	}
...
func runSearch(ctx context.Context, opts *cli.GlobalOpts, args []string) error {
	...
	if opts.Stream {
		...
		return cli.StreamSearch(ctx, opts, opts.Client.V1Products.Search(ctx, params), cap)
	}
	list := opts.Client.V1Products.Search(ctx, params)
